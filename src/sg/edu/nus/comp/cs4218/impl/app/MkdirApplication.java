...
public class MkdirApplication implements MkdirInterface {
	...
	/**
	 * Create folder from the given folder names. Do nothing if folder already
	 * exists. If folder name is a path format, create the folder that satisfies the
	 * path specification.
	 * 
	 * @param folderName
	 *            Array of string of folder names to be created.
	 * @throws MkdirException
	 *             If no args is specified or if the file/folder name is empty or if
	 *             the folder already exists or if the path do not exist.
	 */
	@Override
	 ...
	 *            Array of string of folder names to be created.
	 * @throws MkdirException
	 *             If no foldername is specified or if the file/folder name is empty
	 *             or if the folder already exists or if the path do not exist.
	 */
	@Override
