...
public final class FileUtil {
	...
	/**
	 * Returns the files/folders in the specified folder. Exception is thrown if the
	 * folder path do not exist or is a file.
	 * 
	 * @param fileName
	 *            String of the file path.
	 * 
	 * @throws IOException
	 *             If the folder specified do not exist, is unreadable or is a file.
	 */
	public static String[] getFolderContent(String folderName) throws IOException {
	 ...
	 * 
	 * @throws IOException
	 *             If the file specified do not exist, is unreadable or is a
	 *             directory.
	 */
	public static File getFileFromPath(String fileName) throws IOException {
	...
	/**
	 * Returns the File class of the specified path and throws exception if the
	 * folder cannot be found or is a file.
	 * 
	 * @param fileName
	 ...
	 *             If the folder specified do not exist, is unreadable or is a file.
	 */
	public static File getFolderFromPath(String folderName) throws IOException {
	 ...
	 */
	public static File getFileOrDirectoryFromPath(String fileName) throws IOException {
		Path filePath;
